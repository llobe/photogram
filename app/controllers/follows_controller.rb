class FollowsController < ApplicationController
  def index
    ...
    @follows = @q.result(:distinct => true).includes(:sender, :recipient).page(params[:page]).per(10)
  ...
  def create
    ...
    @follow.sender_id = params[:sender_id]
    @follow.recipient_id = params[:recipient_id]
